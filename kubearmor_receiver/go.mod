...
require (
	github.com/kubearmor/OTel-receiver/stanza_input_operator v0.0.0-20240403153416-7cb0806e9f56
...
require (
	...
	github.com/kubearmor/KubeArmor/protobuf v0.0.0-20240401073901-cdfe3f8b314b // indirect
